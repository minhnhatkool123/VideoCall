...
export default function HomePage(props) {
  ...
  return (
    <View
      ...
      <TextInput
        placeholder="Enter the Conference ID. e.g. 6666, 12"
        style={[styles.input]}
        onChangeText={text =>
          setConferenceID(text.replace(/[^0-9A-Za-z_]/g, ''))
        }
        maxLength={6}
        value={conferenceID}></TextInput>

      <Text style={[styles.conferenceID, styles.leftPadding]}>Name :</Text>
      <TextInput
        placeholder="Enter the Name. e.g. Join, Brow"
        style={[styles.input]}
